...
<div class="row">
        <asp:Button class="btnRegister1" ID="Button6" runat="server" Text="Age Breakdown" OnClick="Button6_Click" />
                    ...
                    <div class="row">
        <asp:Button class="btnRegister1" ID="Button7" runat="server" Text="Lesson Ratings" OnClick="Button7_Click" />
</div>
...
<%--<div class="span6">--%>
    ...
    <div id="lessonRatings" runat="server">
        <script type='text/javascript' src='https://us-east-1.online.tableau.com/javascripts/api/viz_v1.js'></script><div class='tableauPlaceholder' style='width: 100%; height: 848px;'><object class='tableauViz' width='100%' height='848' style='display:none;'><param name='host_url' value='https%3A%2F%2Fus-east-1.online.tableau.com%2F' /> <param name='embed_code_version' value='3' /> <param name='site_root' value='&#47;t&#47;hiphopilluminationmap' /><param name='name' value='YouthUsersMap&#47;Dashboard7' /><param name='tabs' value='no' /><param name='toolbar' value='yes' /><param name='showAppBanner' value='false' /><param name='filter' value='iframeSizedToWindow=true' /></object></div>    
    </div>

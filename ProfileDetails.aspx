<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageLoggedIn.master" AutoEventWireup="true" CodeFile="ProfileDetails.aspx.cs" Inherits="ProfileDetails" ValidateRequest="false" %>
        ...
        <div class="col-sm-4" style="margin: 0 auto">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtUsername" runat="server" EnableViewState="true" CssClass="form-control" Width="400px" Height="30px" Enabled="False"></asp:TextBox>
                    <p class="help-block text-danger"></p>
                </div>
                <div class="form-group">
                    <asp:Label ID="lblFirstName" runat="server" CssClass="col-form-label" Text="First Name"></asp:Label>
                    <asp:TextBox ID="txtFirstName" runat="server" EnableViewState="true" CssClass="form-control" Width="400px" Height="30px" Enabled="False" OnTextChanged="txtFirstName_TextChanged"></asp:TextBox>
                </div>
                <div class="form-group">
                    <asp:Label ID="lblLastName" runat="server" CssClass="col-form-label" Text="Last Name"></asp:Label>
                    <asp:TextBox ID="txtLastName" runat="server" EnableViewState="true" CssClass="form-control" Width="400px" Height="30px" Enabled="False"></asp:TextBox>
                    <p class="help-block text-danger"></p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="DropDowngender" EnableViewState="true" CssClass="form-control" runat="server" Width="400px" Height="30px" Enabled="False">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtFavoriteArtist" runat="server" EnableViewState="true" CssClass="form-control" Width="400px" Height="30px" Enabled="False"></asp:TextBox>
                    <p class="help-block text-danger"></p>
                </div>

                <div class="form-group">
                    <asp:Label ID="lblFavoriteMusic" runat="server" CssClass="col-form-label" Text="Favorite Music"></asp:Label>
                    <asp:TextBox ID="txtFavoriteMusic" runat="server" EnableViewState="true" CssClass="form-control" Width="400px" Height="30px" Enabled="False"></asp:TextBox>
                    <p class="help-block text-danger"></p>
                </div>

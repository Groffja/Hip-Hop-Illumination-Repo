        ...
        .btn-secondary
   {
    ...
    <form id="form2" runat="server">
     <center>
        ...
        <asp:GridView ID="ratingGridView1" runat="server"  AutoGenerateColumns="False" CssClass="table-dark table-striped table-hover" AutoGenerateDeleteButton="True" DataKeyNames="RatingID" DataSourceID="SqlDataSourceRating" CellSpacing="10" Height="10%" Width="70%">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSourceRating" runat="server" ConnectionString="<%$ ConnectionStrings:maxRatingsconnstring %>" SelectCommand="SELECT Ratings.ratingID as RatingID, Documents.Name as Lesson, Ratings.rating as Rating, Ratings.comment as Comment, LoginInfo.username as Username FROM Documents INNER JOIN Ratings ON Documents.ID = Ratings.ID INNER JOIN LoginInfo ON Ratings.accountID = LoginInfo.accountID" DeleteCommand="DELETE FROM [dbo].[Ratings] WHERE ratingID = @RatingID">
            <DeleteParameters>

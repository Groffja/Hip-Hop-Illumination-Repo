...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        .btn-secondary
   {
    ...
    <form id="form2" runat="server">
        ...
        <asp:GridView ID="ratingGridView1" runat="server"  AutoGenerateColumns="False" CssClass="table-dark table-hover" AutoGenerateDeleteButton="True" DataKeyNames="RatingID" DataSourceID="SqlDataSourceRating" CellSpacing="5" Height="175%" Width="90%" CellPadding="2" HorizontalAlign="Center">
            <Columns>

...
h3{
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CssClass="table-dark table-hover" AutoGenerateDeleteButton="True" DataKeyNames="ID" DataSourceID="SqlDataSource1" Width="1128px" Height="337px">
            <Columns>
